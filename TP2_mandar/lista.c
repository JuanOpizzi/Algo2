...
nodo_lista_t* nodo_crear(void* dato, void* sig){
...
bool lista_insertar_primero(lista_t* lista, void* valor){
	nodo_lista_t* aux;
	if (lista_esta_vacia(lista)){
		aux = nodo_crear(valor, NULL);
		lista->ultimo = aux;
	}else{
		aux = nodo_crear(valor, lista->primero);
	}	
	if (!aux){
		return false;
	}
...
bool lista_insertar_ultimo(lista_t *lista, void *dato){
	nodo_lista_t* aux = nodo_crear(dato, NULL);
	if (!aux){
		return false;
	}
	if (lista_esta_vacia(lista)){
...
bool lista_iter_insertar(lista_iter_t *iter, void *dato){
	...
	nodo_lista_t* aux = nodo_crear(dato, iter->actual);
	if (!aux){
		return false;
	}	
